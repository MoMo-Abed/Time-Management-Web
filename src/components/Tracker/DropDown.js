...
const selectStyles = {
    control: provided => ({ ...provided, maxWidth: 150, margin: 8 }),
    menu: () => ({ boxShadow: 'inset 0 1px 0 rgba(0, 0, 0, 0.1)',maxWidth:150,zIndex:1}),
      ...
      return (
        ...
        >
          <Select
            ...
            components={{ SelectContainer,DropdownIndicator, IndicatorSeparator: null }}
